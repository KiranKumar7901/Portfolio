...
const Contact = () => {
  ...
  return (
    <div className="contact-form">
        <div className="w-left" style={darkMode?{display: 'flex',alignItems: 'center',flex: '1',justifyContent: 'center',height: '60vh'}:{}}>
          ...
          <div className="c-right" style={darkMode?{background: 'rgba(245,195,44,0.1)',alignItems: 'center',height:'60vh',borderRadius:'15px'}:{}}>
              <form action="">
