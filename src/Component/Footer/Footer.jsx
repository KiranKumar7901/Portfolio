  ...
  return (
      ...
      <div className="f-content" style={darkMode?{color:'black'}:{}}>
        ...
        <div className="f-icons">
          <a href="https://www.linkedin.com/in/kiran-kumar-514793179"><LinkedIn size='3rem' style={darkMode?{color:'black'}:{}}/></a>
          <a href="https://github.com/KiranKumar7901"><GitHub style={darkMode?{color:'black'}:{}} size='3rem'/></a>
          <a href="https://instagram.com/_karanprajapati_01?utm_source=qr&igshid=MzNINGNkZWQ4Mg%3D%3d"><Instagram style={darkMode?{color:'black'}:{}} size='3rem'/></a>
        </div>
      </div>
    </div>
  )
